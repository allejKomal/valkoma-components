...
export default function ButtonGroupHome() {
  useAutoScroll();
  useRegisterPageSections("Button Group");
  return (
          ...
          <PropsTable
            props={[
              ...
              },
              {
                ...
                default: "undefined",
                description:
                  "Custom CSS classes for the button group container",
              },
              {
              ...
              },
              {
                ...
                default: "undefined",
                description:
                  "Custom render function for complete control over button appearance",
              },
            ]}
          />
